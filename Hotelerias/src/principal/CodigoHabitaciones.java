...
public class CodigoHabitaciones extends JDialog implements ActionListener, MouseListener {
	...
	public CodigoHabitaciones() {
		...
		{
			label = new JLabel("");
			label.setIcon(new ImageIcon(CodigoHabitacion.class.getResource("/imagenes/the-desktop-hd-Windows-7-Black-wallpapers (1).jpeg")));
	...
	protected void do_btnSalir_actionPerformed(ActionEvent arg0) {
		...
		Hospedaje.txtCodigoHabi.setText(dato);
