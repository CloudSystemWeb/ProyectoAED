...
public class CodigoRecepcionistas extends JDialog implements ActionListener, MouseListener {
	...
	protected void do_btnSalir_actionPerformed(ActionEvent arg0) {
		try {
			...
			Hospedaje.txtCodigoRecep.setText(dato);
